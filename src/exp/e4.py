...
class Exp4:
    ...
    def run(self, emotions, randomState, vec:str = 'glove', lr= 0.01):
        ...
        cnn = CNN(X_train_vec, Y_train_one_hot_encoded, vectorizer.vocab_length, vectorizer.embedding_matrix, trainable=True, lr= lr)
        cnn.train()
